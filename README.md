...
This repository keeps its own records under
[docs/engineering](docs/engineering/README.md) — every change made here, why it
was made, and what verified it. The index is generated by `engineering index`
and held current by a test. Run `engineering index` in your own repository to
get the same table.
