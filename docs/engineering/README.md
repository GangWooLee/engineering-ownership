...
| **Let a closed change still record that its owner understood it**<br>`reopen-understanding-review` | R3 | open | [brief](changes/reopen-understanding-review.md), [decision](decisions/reopen-understanding-review.md), [runbook](runbooks/reopen-understanding-review.md), [threat_model](security/reopen-understanding-review.md) |
