...
| **Close the arm-name leak the redaction pass and its guard both missed**<br>`close-arm-name-leak` | R2 | closed 2026-08-05 at `658127ba961f` | [brief](changes/close-arm-name-leak.md), [decision](decisions/close-arm-name-leak.md) |
...
| **Let a closed change still record that its owner understood it**<br>`reopen-understanding-review` | R3 | closed 2026-08-05 at `0d40519de30b` | [brief](changes/reopen-understanding-review.md), [decision](decisions/reopen-understanding-review.md), [runbook](runbooks/reopen-understanding-review.md), [threat_model](security/reopen-understanding-review.md) |
