...
| **Stop naming the arm in the directory the run lives in**<br>`unname-the-fixture-arm` | R2 | open | [brief](changes/unname-the-fixture-arm.md), [decision](decisions/unname-the-fixture-arm.md) |
