...
| **Guard the record conventions with tests, not shipped code**<br>`guard-record-conventions` | R1 | open | [brief](changes/guard-record-conventions.md) |
